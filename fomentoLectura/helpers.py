...
def send_forget_password_mail(email,token):
    #http://webhlectura.co/lecturas/documento/2/
    subject='Your forget password link'
    message=f'Hola, click en el siguiente link para resetear tu contraseña http://webhlectura.co/lecturas/change_password/{token}/'
    email_from= settings.EMAIL_HOST_USER 
